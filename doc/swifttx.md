...
This mechanism has been integrated into Bitcore-Node-PDG which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/private-datagram/insight-api-pdg#web-socket-api](https://github.com/private-datagram/insight-api-pdg#web-socket-api)
* API: [https://github.com/private-datagram/insight-api-pdg#swifttx-transactions](https://github.com/private-datagram/insight-api-pdg#swifttx-transactions)
...
By default, the PDG Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PDG Core daemon:
