...
In order to support loading of multiple wallets in pdg-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pdg.cpp.
...
Changes to pdg.cpp
----------------------
pdg.cpp is the entry point into pdg-qt, and as such, will require some minor modifications to provide hooks for
