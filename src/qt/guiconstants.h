...
/* Pdg GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "PDG"
#define QAPP_ORG_DOMAIN "pdg.org"
#define QAPP_APP_NAME_DEFAULT "PDG-Qt"
#define QAPP_APP_NAME_TESTNET "PDG-Qt-testnet"
