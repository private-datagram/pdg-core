...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PDG address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pdg: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zPDG"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PDG Core"), this);
    aboutAction->setStatusTip(tr("Show information about PDG Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PDG"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PDG addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PDG addresses"));
    ...
    openAction->setStatusTip(tr("Open a PDG: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PDG Core help message to get a list with possible PDG command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PDG Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PDG network", "", count));
}
...
{
    QString strTitle = tr("PDG Core"); // default title
