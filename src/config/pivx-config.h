/* src/config/pdg-config.h.  Generated from pdg-config.h.in by configure.  */
/* src/config/pdg-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "privatedatagram.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Pdg Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Pdg Core 3.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "pdg"
