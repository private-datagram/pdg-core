...
RESOURCES += src/qt/pdg.qrc src/qt/pdg_locale.qrc

TRANSLATIONS += src/qt/locale/pdg_bg.ts \
                src/qt/locale/pdg_de.ts \
                src/qt/locale/pdg_en.ts \
                src/qt/locale/pdg_es.ts \
                src/qt/locale/pdg_fi.ts \
                src/qt/locale/pdg_fr.ts \
                src/qt/locale/pdg_it.ts \
                src/qt/locale/pdg_ja.ts \
                src/qt/locale/pdg_pl.ts \
                src/qt/locale/pdg_pt.ts \
                src/qt/locale/pdg_ru.ts \
                src/qt/locale/pdg_sk.ts \
                src/qt/locale/pdg_sv.ts \
                src/qt/locale/pdg_vi.ts \
                src/qt/locale/pdg_zh_CN.ts \
                src/qt/locale/pdg_zh_TW.ts
