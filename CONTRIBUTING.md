Contributing to PDG Core
============================

The PDG Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PDG Core project, and is not to be
confused with overall PDG Network Protocol consensus changes.

Whether a pull request is merged into PDG Core rests with the project merge
...
Patches that change PDG consensus rules are considerably more involved than
...
Where a patch set proposes to change the PDG consensus, it must have been
...
The project leader is the release manager for each PDG Core release.
